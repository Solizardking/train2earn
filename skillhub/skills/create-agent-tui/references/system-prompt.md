...
const CONTEXT_FILES = ['AGENTS.md', 'CLAWD.md', '.agent-context.md'];
...
Use AGENTS.md / CLAWD.md files in the project root. The `buildSystemPrompt()` function (or the System Prompt Composition module) will find and append them automatically.
