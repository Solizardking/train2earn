...
usage() {
  ...
  echo ""
  echo "Install the Helius x Jupiter DeFi skill for Clawd Code."
  echo ""
  echo "Options:"
  ...
  echo ""
  echo "Examples:"
  echo "  ./install.sh              # Install to ~/.clawd/skills/helius-jupiter/"
  echo "  ./install.sh --project    # Install to ./.clawd/skills/helius-jupiter/"
