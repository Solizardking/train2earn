...
usage() {
  ...
  echo ""
  echo "Install the Helius x DFlow trading skill for Clawd Code."
  echo ""
  echo "Options:"
  ...
  echo ""
  echo "Examples:"
  echo "  ./install.sh              # Install to ~/.clawd/skills/helius-dflow/"
  echo "  ./install.sh --project    # Install to ./.clawd/skills/helius-dflow/"
...
echo "     Configure DFlow MCP over HTTP: https://pond.dflow.net/mcp"
echo ""
