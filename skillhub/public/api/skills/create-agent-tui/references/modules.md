...
Compose the system prompt from a static base plus dynamically loaded context files (similar to how pi-mono loads AGENTS.md/CLAWD.md from project directories).
...
const instructions = composeSystemPrompt({
  ...
  contextFiles: ['AGENTS.md', 'CLAWD.md', '.agent-context.md'],
